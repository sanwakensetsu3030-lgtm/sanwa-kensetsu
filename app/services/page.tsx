...
const achievements = [
  { area: "東京都北区", type: "区道舗装補修工事", scale: "複数路線・年間委託" },
  { area: "東京都北区", type: "道路付属物維持管理", scale: "年間委託" },
  { area: "東京都北区", type: "公園整備工事", scale: "区内各所" },
  { area: "東京都北区", type: "河川護岸補修工事", scale: "区内河川" },
  { area: "東京都北区", type: "緊急道路補修（災害対応）", scale: "随時対応" },
];
