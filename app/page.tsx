    ...
    <>
      ...
      <section style={{ backgroundColor: GREEN, minHeight: "90vh" }} className="relative flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: `repeating-linear-gradient(45deg, ${STRAW} 0px, ${STRAW} 2px, transparent 2px, transparent 80px)`, maskImage: "linear-gradient(to right, black 30%, transparent 65%)", WebkitMaskImage: "linear-gradient(to right, black 30%, transparent 65%)" }}
        />
        <div className="relative z-20 max-w-6xl mx-auto px-4 w-full flex flex-col justify-between" style={{ minHeight: "calc(90vh - 60px)", paddingTop: "2.5vh", paddingBottom: "2.5vh" }}>
          <div className="md:w-3/5">
            <div className="mb-5 flex items-center gap-3">
              ...
              <p style={{ color: STRAW, textShadow: "0 1px 6px rgba(0,0,0,0.7)" }} className="font-bold tracking-widest text-xs uppercase">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-12 max-w-xl">皆さんが日常的に使う道路の整備・補修など日々の管理から災害時の対応まで、いつでも<br />地域のインフラを支えています。<br />目に見える部分はもちろん見えない部分も丁寧に整え、安心して暮らせる環境づくりに取り組んでいます。</p>
