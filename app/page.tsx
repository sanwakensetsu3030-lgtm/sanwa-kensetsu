    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-gray-500 text-sm leading-relaxed mb-12 max-w-xl">皆さんが日常的に使う道路の整備・補修など日々の管理から災害時の対応まで、<br />いつでも地域のインフラを支えています。<br />目に見える部分はもちろん見えない部分も丁寧に整え、安心して暮らせる環境づくりに取り組んでいます。</p>
